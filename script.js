...
//Suffles the array: Used when the sudoku solver funcntion is called
const shuffle = (array) => {
...
numberButtons.forEach(button => {
    ...
    button.addEventListener('mouseenter', () => {
        if (!solvingActivity) {
            btnStyle.style.backgroundColor = '#03f3dfa9';
        }
    })

    button.addEventListener('mouseleave', () => {
        if (!solvingActivity) {
            btnStyle.style.backgroundColor = '#03f3df32';
        }
    })
})
...
operationButtons.forEach(button => {
    ...
    const styleBtnHoverIn = () => {
        btnStyle.style.outline = '2px solid #30d5c8';
    }
...
function notesActivity() {
    ...
    if (noteActive) {
        ...
        notesCurrentState.style.backgroundColor = '#30D5C8';
        notesCurrentState.style.color = 'white';
    } else {
        notesCurrentState.innerText = 'Off';
        notesCurrentState.style.backgroundColor = 'white';
        notesCurrentState.style.color = '#30D5C8';
    }
}
// =========================
...
function solveState() {
    ...
    if (solvingActivity) {
        ...
        solveState.style.color = 'hsl(0, 100%, 40%)';  // red color
    } else {
        solveState.innerText = 'Play';
        solveState.style.backgroundColor = '#30D5C8';
        solveState.style.color = 'white';
    }
}
// ===================
